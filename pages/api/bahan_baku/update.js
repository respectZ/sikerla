...
export default withIronSessionApiRoute(bahanBakuUpdateRoute, ironSessionConfig);

async function bahanBakuUpdateRoute(req, res) {
  ...
  const body = req.body;
  mysql_con.updateBahanBaku(body["id"], body["data"], (_err, _res) => {
    if (_err)
