...
export default withIronSessionApiRoute(cuacaInsertRoute, ironSessionConfig);

async function cuacaInsertRoute(req, res) {
  ...
  const body = req.body;
  mysql_con.insertCuaca(body["data"], (_err, _res) => {
    if (_err)
