...
export default withIronSessionApiRoute(prediksiInsertRoute, ironSessionConfig);

async function prediksiInsertRoute(req, res) {
  ...
  const body = req.body;
  mysql_con.insertPrediksi(body["data"], (_err, _res) => {
    if (_err)
