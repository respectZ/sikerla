...
export default withIronSessionApiRoute(produkDeleteRoute, ironSessionConfig);

async function produkDeleteRoute(req, res) {
  ...
  const body = req.body;
  mysql_con.deleteProduk(body["id"], (_err, _res) => {
    if (_err)
