...
export default withIronSessionApiRoute(produkInsertRoute, ironSessionConfig);

async function produkInsertRoute(req, res) {
  ...
  const body = req.body;
  mysql_con.insertProduk(body["data"], (_err, _res) => {
    if (_err)
