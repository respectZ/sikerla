...
export default withIronSessionApiRoute(produkUpdateRoute, ironSessionConfig);

async function produkUpdateRoute(req, res) {
  ...
  const body = req.body;
  mysql_con.updateProduk(body["id"], body["data"], (_err, _res) => {
    if (_err)
